 ...
 */
final class Version20230813102201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, company_name VARCHAR(255) NOT NULL, registration_code VARCHAR(100) NOT NULL, vat VARCHAR(120) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, mobile_phone VARCHAR(255) DEFAULT NULL, INDEX idx_registration_code (registration_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
